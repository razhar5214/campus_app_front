    ...
    return(
        <div className="add-campus-body">
            ...
            <form onSubmit={submitHandler} className="add-campus-form">
                ...
                Name:
                    <input type="text" name="name" value={name} className="add-campus-input"
                    onChange={(e) => setName(e.target.value)}/>
                </label>
                <label className="add-campus-form-labels">
                Image Url:
                    <input type="text" name="imageUrl" value={imageUrl} className="add-campus-input"
                    onChange={(e) => setImageUrl(e.target.value)}/>
                </label>
                <label className="add-campus-form-labels">
                Address:
                    <input type="text" name="address" value={address} className="add-campus-input"
                    onChange={(e) => setAddress(e.target.value)}/>
                </label>
                <label className="add-campus-form-labels">
                Description :
                    <textarea type="text" name="description" value={description} className="add-campus-input" id="add-campus-description"
